...
public class GeoLocator_Android_MyLocationListener
		...
		android.location.LocationListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HalloWorld.Android.GeoLocator_Android/MyLocationListener, HalloWorld.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GeoLocator_Android_MyLocationListener.class, __md_methods);
	}


	public GeoLocator_Android_MyLocationListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == GeoLocator_Android_MyLocationListener.class)
			mono.android.TypeManager.Activate ("HalloWorld.Android.GeoLocator_Android/MyLocationListener, HalloWorld.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
